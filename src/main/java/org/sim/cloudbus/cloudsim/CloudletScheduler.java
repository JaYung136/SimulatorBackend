...
public abstract class CloudletScheduler {
	...
	public abstract double getCpuUtilization();

	public abstract double getRamUtilization();
	 ...
	 * @post $none
	 */
	public abstract double updateVmProcessing(double currentTime, List<Double> mipsShare, double ram);
	...
	public abstract ResCloudlet choseCloudletToMigrate();
