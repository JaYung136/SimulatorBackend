...
import org.sim.workflowsim.clustering.BasicClustering;
import org.sim.workflowsim.clustering.BlockClustering;
import org.sim.workflowsim.clustering.HorizontalClustering;
import org.sim.workflowsim.clustering.VerticalClustering;
import org.sim.workflowsim.utils.ClusteringParameters;
...
import org.sim.workflowsim.clustering.balancing.BalancedClustering;
...
public final class ClusteringEngine extends SimEntity {
    ...
    protected void processDatastaging() {
         ...
         * next available id
         */
        Job job = new Job(getJobList().size(), 0);
    ...
    public void processEvent(SimEvent ev) {
        ...
        switch (ev.getTag()) {
            ...
            case WorkflowSimTags.JOB_SUBMIT:
                ...
                setTaskList(list);
                //Log.printLine("Task's size: " + list.size());
                /**
     ...
     * This method is called by for incoming unknown tags.
     *
     * @param ev a SimEvent object
     * @pre ev != null
     * @post $none
