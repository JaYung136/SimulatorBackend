...
package org.sim.cloudsimsdn.core;

import org.sim.cloudsimsdn.Log;
import org.sim.cloudsimsdn.core.predicates.Predicate;
...
public class CloudSim {
	...
	private static double minTimeBetweenEvents = 0.0000000001;
	...
	/** entities处理 deferred events后，第一次检查 future为空，则返回 true。
	...
	/**
	 * 注意这里调用的是CloudSim的 processEvent。
	 * 处理系统事件，e.g.将消息（SimEvent.SEND）从future队列转移到deferred队列
	 * @param e the e
	 */
